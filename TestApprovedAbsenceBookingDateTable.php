...
function testApprovedAbsenceBookingDateTable() {
    $date = CreateDate("2014-12-25", NULL);
    if ($date) {
        ...
        //CREATE
        $approvedAbsenceBookingDate = CreateApprovedAbsenceBookingDate($date[DATE_TABLE_DATE_ID], $approvedAbsenceBooking[APPR_ABS_BOOKING_ID]);
        //RETRIEVE
        ...
        if ($approvedAbsenceBookings <> NULL) {
            foreach ($approvedAbsenceBookings as $approvedAbsenceBookingDate) {
                //UPDATE
